# Dunia2 Tools
This a toolset designed for Ivory Tower's version of Dunia (called Babel) for The Crew and The Crew 2.
...
## Usage
> [!IMPORTANT]
> If working with The Crew 2, change `The Crew` in `current.txt` found in the projects folder to `The Crew 2` and copy `oo2core_5_win64.dll` from your game folder into the folder of this program.
